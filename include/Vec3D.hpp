...
/// \param _y: y
/// \param _z: z
inline Vec3D::Vec3D(VEC3D_T _x, VEC3D_T _y, VEC3D_T _z) : x(_x), y(_y), z(_z) {
  // nothing to see here
}

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/// Method for vector norm
inline VEC3D_T Vec3D::Norm() const { return sqrt(x * x + y * y + z * z); }

//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/// Method for vector norm in square
inline VEC3D_T Vec3D::Norm2() const { return x * x + y * y + z * z; }
...
/// \param v: vector
inline Vec3D &Vec3D::Reset(const Vec3D &v) { return *this = v; }
...
*/
inline Vec3D &Vec3D::operator^=(const Vec3D &v) {
  Vec3D temp(y * v.z - z * v.y, z * v.x - x * v.z, x * v.y - y * v.x);
  *this = temp;
  return *this;
}
