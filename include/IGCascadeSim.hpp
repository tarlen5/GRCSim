...
private:
  ...
  // Private Functions   ///////////////////////////////
  //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  void ProcessOptions(AnyOption *opt, string &eblmodel, string &mf_dir,
                      string &opt_depth_dir, string &output_dir);
  ...
  string DefineTrackLeptonFile(const string &s_eblmodel, const string &s_egy,
                               ...
                               const string &output_dir);
  string DefineTrackTimeDelayFile(const string &s_eblmodel, const string &s_egy,
                                  const string &s_Bmag, const string &s_ze,
                                  const string &s_cellsize,
                                  const string &s_file_num);
  void DefineRp(void);
  ...
  bool PropagateSecondaryPhoton(RelParticle &GammaPhoton, RelParticle *Electron,
